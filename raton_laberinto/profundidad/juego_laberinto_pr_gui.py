...
class LaberintoGUI:
    def __init__(self, master_window, laberinto_mapa):
        ...
        self.root.title("Laberinto - Solución con Búsqueda por Profundidad (DFS)")
    ...
    def iniciar_busqueda(self):
        ...
        self.label_estado.config(text="Ejecutando Búsqueda por Profundidad...")
        self.root.update()
...
def iniciar_juego_profundidad(master_window):
    LABERINTO_MAPA = [
        ['#', 'I', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#', '#'],
        ['#', '.', '.', '.', '#', '.', '.', '.', '.', '.', '.', '.', '#', '.', '.', '.', '.', '.', '.', '#'],
        ['#', '.', '#', '.', '#', '.', '#', '#', '#', '#', '#', '.', '#', '.', '#', '#', '#', '#', '.', '#'],
...
if __name__ == "__main__":
    ...
    iniciar_juego_profundidad(main_launcher)
